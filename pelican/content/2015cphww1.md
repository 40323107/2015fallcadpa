...
1.內容：
    ...
    輸出字串。(※字串為 Hello ) 
    建立個人 Github 課程倉儲 。(※名稱為 2015cadp )
    使用 Git 在近端建立分支，並推送至遠端。(※運用 git branch )
    使用 SciTE 新增網頁，並利用 git 推送至 Github。(※網頁：index.html )
...
<iframe src="https://vimeo.com/140277094" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><a href="https://vimeo.com/140277094">Welcome Speech</a> from <a href="https://vimeo.com/user24079973">虎尾科大機械設計工程系 KMOL</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
